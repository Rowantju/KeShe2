...
namespace MiShi
{
    ...
    public sealed partial class South : Page
    {
        ...
        private void SouthLeftButton_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(East));
        }

        private void SouthRightButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        {
            this.Frame.Navigate(typeof(OpenedDoor));
        }
    }
}
